...
def run_pipeline(
    ...
    ophone_frontmatter = build_output_frontmatter(
        ...
        stage_data={
            ...
            'post_unit_drift_extension_count': ophone_report['post_unit_drift_extension_count'],
            'post_unit_drift_extension_denominator': ophone_report['post_unit_drift_extension_denominator'],
            'post_unit_drift_extension_rate': ophone_report['post_unit_drift_extension_rate'],
            'max_post_unit_drift_extension': ophone_report['max_post_unit_drift_extension'],
            'syllable_unit_count': ophone_report['syllable_unit_count'],
            'pause_unit_count': ophone_report['pause_unit_count'],
            'mini_pause_row_count': ophone_report['mini_pause_row_count'],
            'completed_unit_count': ophone_report['completed_unit_count'],
            'ordinary_vowel_correction_count': ophone_report['ordinary_vowel_correction_count'],
            'ordinary_vowel_correction_denominator': ophone_report['ordinary_vowel_correction_denominator'],
            'ordinary_vowel_correction_rate': ophone_report['ordinary_vowel_correction_rate'],
            'ordinary_vowel_correction_shorten_count': ophone_report['ordinary_vowel_correction_shorten_count'],
            'ordinary_vowel_correction_lengthen_count': ophone_report['ordinary_vowel_correction_lengthen_count'],
            'mini_pause_insert_count': ophone_report['mini_pause_insert_count'],
            'mini_pause_eligible_count': ophone_report['mini_pause_eligible_count'],
            'mini_pause_insert_denominator': ophone_report['mini_pause_insert_denominator'],
            'mini_pause_insert_rate': ophone_report['mini_pause_insert_rate'],
            'mini_pause_success_rate_over_eligible': ophone_report['mini_pause_success_rate_over_eligible'],
            'pause_residual_post_unit_drift_count': ophone_report['pause_residual_post_unit_drift_count'],
            'pause_residual_post_unit_drift_denominator': ophone_report['pause_residual_post_unit_drift_denominator'],
            'pause_residual_post_unit_drift_rate': ophone_report['pause_residual_post_unit_drift_rate'],
        },
        file_format='phone',
    )
    phone_frontmatter = build_output_frontmatter(
        ...
        stage_data={
            ...
            'post_unit_drift_extension_count': phone_report['post_unit_drift_extension_count'],
            'post_unit_drift_extension_denominator': phone_report['post_unit_drift_extension_denominator'],
            'post_unit_drift_extension_rate': phone_report['post_unit_drift_extension_rate'],
            'max_post_unit_drift_extension': phone_report['max_post_unit_drift_extension'],
            'syllable_unit_count': phone_report['syllable_unit_count'],
            'pause_unit_count': phone_report['pause_unit_count'],
            'mini_pause_row_count': phone_report['mini_pause_row_count'],
            'completed_unit_count': phone_report['completed_unit_count'],
            'ordinary_vowel_correction_count': phone_report['ordinary_vowel_correction_count'],
            'ordinary_vowel_correction_denominator': phone_report['ordinary_vowel_correction_denominator'],
            'ordinary_vowel_correction_rate': phone_report['ordinary_vowel_correction_rate'],
            'ordinary_vowel_correction_shorten_count': phone_report['ordinary_vowel_correction_shorten_count'],
            'ordinary_vowel_correction_lengthen_count': phone_report['ordinary_vowel_correction_lengthen_count'],
            'mini_pause_insert_count': phone_report['mini_pause_insert_count'],
            'mini_pause_eligible_count': phone_report['mini_pause_eligible_count'],
            'mini_pause_insert_denominator': phone_report['mini_pause_insert_denominator'],
            'mini_pause_insert_rate': phone_report['mini_pause_insert_rate'],
            'mini_pause_success_rate_over_eligible': phone_report['mini_pause_success_rate_over_eligible'],
            'pause_residual_post_unit_drift_count': phone_report['pause_residual_post_unit_drift_count'],
            'pause_residual_post_unit_drift_denominator': phone_report['pause_residual_post_unit_drift_denominator'],
            'pause_residual_post_unit_drift_rate': phone_report['pause_residual_post_unit_drift_rate'],
        },
        file_format='phone',
    )
