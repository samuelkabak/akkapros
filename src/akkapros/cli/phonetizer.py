...
def main() -> None:
    ...
    original_frontmatter = build_output_frontmatter(
        ...
        stage_data={
            ...
            'post_unit_drift': original_report['post_unit_drift'],
            'post_unit_drift_extension_count': original_report['post_unit_drift_extension_count'],
            'post_unit_drift_extension_denominator': original_report['post_unit_drift_extension_denominator'],
            'post_unit_drift_extension_rate': original_report['post_unit_drift_extension_rate'],
            'max_post_unit_drift_extension': original_report['max_post_unit_drift_extension'],
            'syllable_unit_count': original_report['syllable_unit_count'],
            'pause_unit_count': original_report['pause_unit_count'],
            'mini_pause_row_count': original_report['mini_pause_row_count'],
            'completed_unit_count': original_report['completed_unit_count'],
            'ordinary_vowel_correction_count': original_report['ordinary_vowel_correction_count'],
            'ordinary_vowel_correction_denominator': original_report['ordinary_vowel_correction_denominator'],
            'ordinary_vowel_correction_rate': original_report['ordinary_vowel_correction_rate'],
            'ordinary_vowel_correction_shorten_count': original_report['ordinary_vowel_correction_shorten_count'],
            'ordinary_vowel_correction_lengthen_count': original_report['ordinary_vowel_correction_lengthen_count'],
            'mini_pause_insert_count': original_report['mini_pause_insert_count'],
            'mini_pause_eligible_count': original_report['mini_pause_eligible_count'],
            'mini_pause_insert_denominator': original_report['mini_pause_insert_denominator'],
            'mini_pause_insert_rate': original_report['mini_pause_insert_rate'],
            'mini_pause_success_rate_over_eligible': original_report['mini_pause_success_rate_over_eligible'],
            'pause_residual_post_unit_drift_count': original_report['pause_residual_post_unit_drift_count'],
            'pause_residual_post_unit_drift_denominator': original_report['pause_residual_post_unit_drift_denominator'],
            'pause_residual_post_unit_drift_rate': original_report['pause_residual_post_unit_drift_rate'],
        },
        file_format='phone',
    )
    accentuated_frontmatter = build_output_frontmatter(
        ...
        stage_data={
            ...
            'post_unit_drift': accentuated_report['post_unit_drift'],
            'post_unit_drift_extension_count': accentuated_report['post_unit_drift_extension_count'],
            'post_unit_drift_extension_denominator': accentuated_report['post_unit_drift_extension_denominator'],
            'post_unit_drift_extension_rate': accentuated_report['post_unit_drift_extension_rate'],
            'max_post_unit_drift_extension': accentuated_report['max_post_unit_drift_extension'],
            'syllable_unit_count': accentuated_report['syllable_unit_count'],
            'pause_unit_count': accentuated_report['pause_unit_count'],
            'mini_pause_row_count': accentuated_report['mini_pause_row_count'],
            'completed_unit_count': accentuated_report['completed_unit_count'],
            'ordinary_vowel_correction_count': accentuated_report['ordinary_vowel_correction_count'],
            'ordinary_vowel_correction_denominator': accentuated_report['ordinary_vowel_correction_denominator'],
            'ordinary_vowel_correction_rate': accentuated_report['ordinary_vowel_correction_rate'],
            'ordinary_vowel_correction_shorten_count': accentuated_report['ordinary_vowel_correction_shorten_count'],
            'ordinary_vowel_correction_lengthen_count': accentuated_report['ordinary_vowel_correction_lengthen_count'],
            'mini_pause_insert_count': accentuated_report['mini_pause_insert_count'],
            'mini_pause_eligible_count': accentuated_report['mini_pause_eligible_count'],
            'mini_pause_insert_denominator': accentuated_report['mini_pause_insert_denominator'],
            'mini_pause_insert_rate': accentuated_report['mini_pause_insert_rate'],
            'mini_pause_success_rate_over_eligible': accentuated_report['mini_pause_success_rate_over_eligible'],
            'pause_residual_post_unit_drift_count': accentuated_report['pause_residual_post_unit_drift_count'],
            'pause_residual_post_unit_drift_denominator': accentuated_report['pause_residual_post_unit_drift_denominator'],
            'pause_residual_post_unit_drift_rate': accentuated_report['pause_residual_post_unit_drift_rate'],
        },
        file_format='phone',
    )
