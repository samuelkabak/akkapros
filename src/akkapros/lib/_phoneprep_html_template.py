"""
HTML template for the Akkadian Recording Assistant.

Extracted to a separate file so that HTML/JS/CSS editing (which benefits
from different LLM skills) does not mix with Python logic in phoneprep.py.
"""

PHONEPREP_HTML_TEMPLATE = """<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
