...
def run_tests() -> bool:
    ...
    tests = [
        ...
        (
            ...
            "ipa",
            "ʔana se.bet.ti ⟨pause⟩ (.) qɒr.ˈraːːd ⟨pause⟩ (.) laː ʃa.naːn ⟨emdash⟩ (..) ˈnanː.dɨ.qɒː ⟨pause⟩ (.) kak.kiː.kun",
        ),
        (
            "ṣal·mā~t qaq·qa·di ana+šu·mut·ti — šum·qu·tu bū~l šak·kan",
            "ipa",
            "sˤɒl.ˈmaːːt ⟨pause⟩ (.) qɒq.qɒ.di ⟨pause⟩ (.) ʔana ʃu.mut.ti ⟨emdash⟩ (..) ʃum.qɯ.tu ⟨pause⟩ (.) ˈbuːːl ⟨pause⟩ (.) ʃak.kan",
        ),
        ("ba", "ipa", "ba"),
        ("bā", "ipa", "baː"),
        ("baq", "ipa", "bɒq"),
