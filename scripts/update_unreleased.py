...
Defaults to base tag ``v3.0.0``. The script replaces the "Commits since release"
...
def main(argv: List[str] | None = None) -> int:
    ...
    p.add_argument("--base", default="v3.0.0", help="Base ref/tag to list commits since (default: v3.0.0)")
