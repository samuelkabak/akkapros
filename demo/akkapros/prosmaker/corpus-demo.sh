...
python src/akkapros/cli/phonetizer.py "$resultsDir/corpus-lob_tilde.txt" -p corpus-lob --outdir "$resultsDir"
python src/akkapros/cli/phonetizer.py "$resultsDir/corpus-mono-lob_tilde.txt" -p corpus-mono-lob --outdir "$resultsDir"
python src/akkapros/cli/phonetizer.py "$resultsDir/corpus-sob_tilde.txt" -p corpus-sob --outdir "$resultsDir"
python src/akkapros/cli/metricalc.py "$resultsDir/corpus-lob_phone.txt" --table --json -p corpus-lob --outdir "$resultsDir"
python src/akkapros/cli/metricalc.py "$resultsDir/corpus-mono-lob_phone.txt" --table --json -p corpus-mono-lob --outdir "$resultsDir"
python src/akkapros/cli/metricalc.py "$resultsDir/corpus-sob_phone.txt" --table --json -p corpus-sob --outdir "$resultsDir"
