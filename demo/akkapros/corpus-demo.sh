...
python src/akkapros/cli/metricser.py "$resultsDir/corpus-lob_tilde.txt" --table --pause-ratio 30 -p corpus-lob-p30 --outdir "$resultsDir"
python src/akkapros/cli/metricser.py "$resultsDir/corpus-lob_tilde.txt" --table --pause-ratio 35 -p corpus-lob-p35 --outdir "$resultsDir"
python src/akkapros/cli/metricser.py "$resultsDir/corpus-lob_tilde.txt" --table --pause-ratio 40 -p corpus-lob-p40 --outdir "$resultsDir"
echo "Running metrics (SOB, pause ratios 30/35/40)..."
python src/akkapros/cli/metricser.py "$resultsDir/corpus-sob_tilde.txt" --table --pause-ratio 30 -p corpus-sob-p30 --outdir "$resultsDir"
python src/akkapros/cli/metricser.py "$resultsDir/corpus-sob_tilde.txt" --table --pause-ratio 35 -p corpus-sob-p35 --outdir "$resultsDir"
python src/akkapros/cli/metricser.py "$resultsDir/corpus-sob_tilde.txt" --table --pause-ratio 40 -p corpus-sob-p40 --outdir "$resultsDir"
