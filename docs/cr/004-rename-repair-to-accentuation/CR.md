...
- Test files and fixtures (refer to `docs/adr/014-cli-built-in-self-tests.md` for locations)
- Documentation in `docs/` and `docs/cr/`
...
- Use the guidance in `docs/cr/README.md` for CR workflow and `docs/adr/` for architectural context.
