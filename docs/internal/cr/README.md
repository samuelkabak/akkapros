...
docs/internal/cr/000-cr-template/
...
docs/internal/cr/005-add-webhook-support/

3. Copy the template files from:

docs/internal/cr/000-cr-template/

4. Refer to ADRs in docs/internal/adr/* as architecture guidelines
...
docs/internal/cr/NNN-short-title/
...
Create a new Change Request following the principles in docs/internal/cr/README.md to implement the following features:
